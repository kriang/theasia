                ...
                <div className="col-xs-12">
                    ...
                    <div className="row">
                        ...
                        <div className="col-xs-12 col-md-3">
                            <i className="glyphicon glyphicon-map-marker"></i> Departure: Singapore
                        </div>
                        <div className="col-xs-12 col-md-9">
                            ...
                            <div className="row text-center">
                                <div className="col-xs-4">
                                    <div>
                                        <img src="http://ex.theasia.com/en/icons/img-ticket.png" alt="Type" className="icon" />
                                    </div>
                                    <div>
                                        <strong>Type</strong>
                                        <div>Ticket</div>
                                ...
                                <div className="col-xs-4">
                                    <div>
                                        <img src="http://ex.theasia.com/en/icons/img-open.png" alt="Open Hours" className="icon" />
                                    </div>
                                    <div>
                                ...
                                <div className="col-xs-4">
                                    <div>
                                        <img src="http://ex.theasia.com/en/icons/img-calendar.png" alt="Available Day" className="icon" />
                                    </div>
                                    <div>
